...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      "tw-relative tw-flex hover:tw-cursor-pointer  tw-cursor-default tw-gap-2 tw-select-none tw-items-center tw-rounded-sm tw-px-2 tw-py-1.5 tw-text-sm tw-outline-none data-[disabled=true]:tw-pointer-events-none data-[selected=true]:tw-bg-[#F27052] data-[selected=true]:tw-text-white data-[disabled=true]:tw-opacity-50 [&_svg]:tw-pointer-events-none [&_svg]:tw-text-[#D96046] [&_svg]:tw-shrink-0 hover:tw-bg-[#F48F73]"
      ,
      className
    )}
    {...props}
