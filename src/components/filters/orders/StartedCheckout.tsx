  ...
  return (
    <div className="min-w-fit flex gap-5 items-center">
      ...
      <Combobox
        key={index}
        type="order"
        defaultValue={{ value: "startedCheckout", label: <>Started checkout</> }}
      />
      ...
      <CustomDropdown
        ...
        defaulValue={filterData?.filterValue.value.operator===""?"after":filterData?.filterValue.value.operator}
